...
To: priti <pritimalode98@gmail.com>, Hasbi <hasbi@gmail.com>
From: Organis <admin@admin.com>
Subject: ORD-5425461 - Your order is successfully.
Message-ID: <kYjvDqAMYf2EImd7PtDX5eyD9Qh6O7YloScxAiMo@localhost>
														...
														<tr>
															<td style="vertical-align: top;">
																...
																<table style="padding:30px 0px;" border="0" cellpadding="3" cellspacing="0" width="100%">
																	...
																	<tr><td>House # 2/C/3/A, Road # 1, Shyamoli, Dhaka, Bangladesh</td></tr>
																	<tr><td>organis@gmail.com</td></tr>
																	<tr><td>01215123456789</td></tr>
																</table>
															</td>
															<td style="vertical-align: top;">
																<table style="text-align:right;" border="0" cellpadding="3" cellspacing="0" width="100%">
																	<tr><td><strong>Order Date</strong>: 20-05-2023</td></tr>
																	<tr><td><strong>Payment Method</strong>: Bank Transfer</td></tr>
																	<tr><td><strong>Payment Status</strong>: <span style="color:#fe9e42">Pending</span></td></tr>
																	<tr><td><strong>Order Status</strong>: <span style="color:#fe9e42">Awaiting</span></td></tr>
																</table>
															</td>
														</tr>
													</table>
											...
											<tr>
												<td>
													<table style="border-collapse:collapse;" border="0" cellpadding="5" cellspacing="0" width="100%">
														...
														<tr>
								<td colspan="3" style="width:100%;text-align:left;border:1px solid #ddd;background-color:#f7f7f7;font-weight:bold;">Sold By: <a href="http://localhost/Grocery/stores/47/hasbi"> Hasbi</a>, Order#: <a href="http://localhost/Grocery/order-invoice/478/ORD-5425461"> ORD-5425461</a></td>
							</tr><tr>
												...
												<td style="padding-top:5px;padding-bottom:20px;">
													<table style="font-weight:bold;" border="0" cellpadding="5" cellspacing="0" width="100%">
														...
														<tr>
															...
															<td style="width:15%;text-align:right;">{{Cart::tax()}}</td>
														</tr>
														<tr>
															<td style="width:85%;text-align:right;">Subtotal:</td>
															<td style="width:15%;text-align:right;">{{Cart::subtotal()}}</td>
														</tr>
														<tr>
															<td style="width:85%;text-align:right;">Total:</td>
															<td style="width:15%;text-align:right;">{{Cart::total()}}</td>
														</tr>
													</table>
												</td>
											</tr>
											<tr><td style="padding-top:30px;padding-bottom:50px;"><a href="http://localhost/Grocery/order-invoice/478/ORD-5425461" style="background:#61a402;display:block;text-align:center;padding:7px 15px;margin:0 10px 10px 0;border-radius:3px;text-decoration:none;color:#fff;float:left;">Invoice (ORD-5425461)</a></td></tr>
											<tr><td style="padding-top:10px;border-top:1px solid #ddd;text-align:center;">Thank you for purchasing our products.</td></tr>
											<tr><td style="padding-top:5px;text-align:center;">If you have any questions about this invoice, please contact us</td></tr>
											<tr><td style="padding-top:5px;text-align:center;"><a href="http://localhost/Grocery">http://localhost/Grocery</a></td></tr>
										</table>
									</td>
								</tr>
							</table>
